...
<body>
    ...
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="ManageStaff" role="tabpanel" aria-labelledby="ManageStaff-tab">
                <div class="container">
                            ...
                            <form action="<?php echo site_url('staff/index'); ?>" class="form-inline" method="get">
                                <div class="input-group">
                                    ...
                                    <span class="group-btn">
                                        ...
                                        if ($q <> '') {
                                        ?>
                                            <a href="<?php echo site_url('staff'); ?>" class="btn btn-dark">Reset</a>
                                        <?php
                                        }
                                        ?>
                    ...
                    <table class="table table-bordered" style="margin-bottom: 10px">
                        <tr>
                            ...
                            <th style="text-align:center">Staff Phone Number</>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo anchor(site_url('staff/word'), 'Word', 'class="btn btn-dark"'); ?>
