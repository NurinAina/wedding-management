    ...
    <div class="container">
        <form action="<?php echo $action; ?>" method="post">
            <div class="form-group">
                <label for="varchar">Staff Name <?php echo form_error('staffName') ?></label>
                <input type="text" class="form-control" name="staffName" id="staffName" placeholder="Staff Name" value="<?php echo $staffName; ?>" />
            </div>
            <div class="form-group">
                <label for="varchar">Staff Address <?php echo form_error('staffAdd') ?></label>
                <input type="text" class="form-control" name="staffAdd" id="staffAdd" placeholder="Staff Address" value="<?php echo $staffAdd; ?>" />
            </div>
            <div class="form-group">
                <label for="int">Staff Phone Number <?php echo form_error('staffPhone') ?></label>
                <input type="text" class="form-control" name="staffPhone" id="staffPhone" placeholder="Staff Phone Number" value="<?php echo $staffPhone; ?>" />
            </div>
            <div class="form-group">
            ...
            <a href="<?php echo site_url('staff') ?>" class="btn btn-dark">Cancel</a>
        </form>
    </div>
</body>
