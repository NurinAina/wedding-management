...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('customer/create'), 'Create', 'class="btn btn-dark"'); ?>
            </div>
                ...
                <form action="<?php echo site_url('customer/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            ...
                            if ($q <> '') {
                            ?>
                                <a href="<?php echo site_url('customer'); ?>" class="btn btn-dark">Reset</a>
                            <?php
                            }
                            ?>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center" width="200px">
                        <?php
                        echo anchor(site_url('customer/update/' . $customer->cusId), 'Update');
                        ?>
                    </td>
                </tr>
            <?php
        ...
        <div class="row">
            <div class="col-md-6">
                <?php echo anchor(site_url('customer/word'), 'Word', 'class="btn btn-dark"'); ?>
