    ...
    <div class="container">
        ...
        <form action="<?php echo $action; ?>" method="post">
            <div class="form-group">
                <label for="varchar">Payment Status <?php echo form_error('payStatus') ?></label>
                <input type="text" class="form-control" name="payStatus" id="payStatus" placeholder="Done/Pending" value="<?php echo $payStatus; ?>" />
            </div>
            <div class="form-group">
                <label for="datetime">Payment Date <?php echo form_error('payDate') ?></label>
                <input type="text" class="form-control" name="payDate" id="payDate" placeholder="0000-00-00" value="<?php echo $payDate; ?>" />
            </div>
