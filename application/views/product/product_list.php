...
<body>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('product/create'), 'Create', 'class="btn btn-dark"'); ?>
            </div>
                ...
                <form action="<?php echo site_url('product/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="group-btn">
                            ...
                            if ($q <> '') {
                            ?>
                                <a href="<?php echo site_url('product'); ?>" class="btn btn-dark">Reset</a>
                            <?php
                            }
                            ?>
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:center" width="200px">
                        <?php
                        echo anchor(site_url('product/read/' . $product->proId), 'Read');
                        echo ' | ';
                        echo anchor(site_url('product/update/' . $product->proId), 'Update');
                        echo ' | ';
                        echo anchor(site_url('product/delete/' . $product->proId), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                        ?>
                    </td>
                </tr>
            <?php
