...
<body>
    ...
    <div class="container">
	    ...
	    <tr><td>BookDate</td><td><?php echo $bookDate; ?></td></tr>
	    <tr><td>ProId</td><td><?php echo $proId; ?></td></tr>
	    <tr><td>PayId</td><td><?php echo $payId; ?></td></tr>
	    <tr><td></td><td><a href=" <?php echo site_url('booking') ?>" class="btn btn-default">Cancel</a></td>
            </tr>
        </table>
    </div>
</body>
